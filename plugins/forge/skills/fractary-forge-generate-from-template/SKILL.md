...
```json
{
  "template_file": "plugins/forge/templates/agent/manager.md.template",
...
Path checked: plugins/forge/templates/agent/manager.md.template
Available templates:
  • plugins/forge/templates/agent/manager.md.template
  • plugins/forge/templates/agent/handler.md.template
  • plugins/forge/templates/skill/basic-skill.md.template
```
