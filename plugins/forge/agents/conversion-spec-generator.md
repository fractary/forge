...
Use the @skill-fractary-forge:spec-generator skill with operation `load-audit-results`:
```json
{
...
Use the @skill-fractary-forge:project-analyzer skill to inspect specific entity:
```json
{
...
**Execute:**
Use the @skill-fractary-forge:spec-generator skill with operation `analyze-conversions`:
```json
{
...
For each approved conversion, use the @skill-fractary-forge:spec-generator skill:
...
Use the @skill-fractary-forge:spec-generator skill with operation `validate-specs`:
```json
{
