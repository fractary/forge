...
Use the @skill-fractary-forge:workflow-designer skill with operation `design-architecture`:
```json
{
...
Use the @skill-fractary-forge:workflow-designer skill with operation `create-manager-agent`:
```json
{
...
Use the @skill-fractary-forge:workflow-designer skill with operation `validate-workflow`:
```json
{
