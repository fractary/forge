...
Use @skill-fractary-forge:csv-fetcher to fetch CSV file:
...
Use @skill-fractary-forge:csv-validator to validate:
...
If approved, use @skill-fractary-forge:csv-transformer:
...
Use @skill-fractary-forge:csv-loader:
