...
Use @skill-fractary-forge:code-linter to lint code:
...
Use @skill-fractary-forge:code-builder to build:
...
Use @skill-fractary-forge:test-runner to run tests:
...
1. Run `/fractary-forge:audit` to find other hybrids
