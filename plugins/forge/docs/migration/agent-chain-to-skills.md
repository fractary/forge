...
Use @skill-fractary-forge:data-fetcher to fetch data:
...
Use @skill-fractary-forge:data-validator to validate:
...
If approved, use @skill-fractary-forge:data-processor:
...
```markdown
## Phase 5: Process
Use @skill-fractary-forge:data-processor:  # ✓ Invoke skill
...
1. Run `/fractary-forge:audit` to find other anti-patterns
