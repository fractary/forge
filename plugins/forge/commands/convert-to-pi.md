---
name: fractary-forge:convert-to-pi
description: Convert a Claude Code plugin to a pi.dev coding-agent package
allowed-tools: Task(fractary-forge:plugin-to-pi-converter)
...
```
/fractary-forge:convert-to-pi <plugin-path> [--output <dir>] [--dry-run]
```
...
Usage: /fractary-forge:convert-to-pi <plugin-path> [--output <dir>] [--dry-run]
```
...
/fractary-forge:convert-to-pi /mnt/c/GitHub/fractary/core/plugins/file

# Convert with explicit output directory
/fractary-forge:convert-to-pi /mnt/c/GitHub/fractary/core/plugins/file --output /tmp/pi-packages

# Dry run - show plan without writing files
/fractary-forge:convert-to-pi plugins/docs --dry-run

# Convert a local plugin
/fractary-forge:convert-to-pi plugins/forge-agent --output /tmp/pi-test
```
</EXAMPLES>
