...
/fractary-forge:create-skill data-fetcher

# Create a handler skill in specific plugin
/fractary-forge:create-skill terraform-deployer --handler-type iac --plugin faber-cloud

# Create with custom tools
/fractary-forge:create-skill api-client --tools "Bash, Read, WebFetch"
```
...
Usage: /fractary-forge:create-skill <name>
```
...
/fractary-forge:create-skill api-client --description "Fetches data from REST APIs"

# Skill with custom tools
/fractary-forge:create-skill file-processor --tools "Bash, Read, Write, Edit"
```
