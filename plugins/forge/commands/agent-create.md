...
/fractary-forge:create-agent data-analyzer --type manager

# Create a handler agent in specific plugin
/fractary-forge:create-agent terraform-deployer --type handler --plugin faber-cloud

# Create with custom tools
/fractary-forge:create-agent api-client --type manager --tools "Bash, Skill, WebFetch"
```
...
Usage: /fractary-forge:create-agent <name> --type <manager|handler>
```
...
/fractary-forge:create-agent workflow-manager --type manager --description "Orchestrates complete FABER workflows"
...
- `/fractary-forge:create-command` - Create a command
