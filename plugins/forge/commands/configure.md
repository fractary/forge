...
Your role is to parse user input and invoke the forge-configurator agent with the appropriate request.
</CONTEXT>

<CRITICAL_RULES>
**YOU MUST:**
- Parse the command arguments from user input
- Invoke the forge-configurator agent
...
4. **Invoke agent**
   - Invoke forge-configurator agent with the structured request
...
**Agent**: forge-configurator (or @agent-fractary-forge:forge-configurator)
...
- **forge-configurator agent** - Orchestrates configuration workflow
