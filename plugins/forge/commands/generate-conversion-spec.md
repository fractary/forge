...
**Command Format:**
```bash
/fractary-forge:generate-conversion-spec [options]
...
/fractary-forge:generate-conversion-spec --audit-results audit.json

# Generate spec for specific entity
/fractary-forge:generate-conversion-spec --entity catalog-processor --pattern agent-chain

# Generate high-priority conversions only
/fractary-forge:generate-conversion-spec --priority high --output high-priority-conversions.md

# Interactive mode
/fractary-forge:generate-conversion-spec --interactive

# JSON output for automation
/fractary-forge:generate-conversion-spec --format json --output conversion.json
```
...
Use the @agent-fractary-forge:conversion-spec-generator agent with the structured request.

**Invocation:**
```
Use the @agent-fractary-forge:conversion-spec-generator agent to generate a conversion specification with the following request:
