...
**Command Format:**
```bash
/fractary-forge:create-workflow <workflow-name> [options]
...
/fractary-forge:create-workflow data-processor

# Create with specific pattern
/fractary-forge:create-workflow code-fixer --pattern builder-debugger

# Create with batch support
/fractary-forge:create-workflow file-processor --batch --domain data

# Create with description
/fractary-forge:create-workflow api-client --description "Integrate with external APIs"

# Non-interactive mode
/fractary-forge:create-workflow validator --no-interactive --domain data
```
...
Use the @agent-fractary-forge:workflow-creator agent with the structured request.

**Invocation:**
```
Use the @agent-fractary-forge:workflow-creator agent to create a new workflow with the following request:
...
Usage: /fractary-forge:create-workflow <workflow-name> [options]

Examples:
  /fractary-forge:create-workflow data-processor
  /fractary-forge:create-workflow code-fixer --pattern builder-debugger
  /fractary-forge:create-workflow api-client --batch
```
