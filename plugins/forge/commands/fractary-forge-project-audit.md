...
allowed-tools: Agent(fractary-forge-project-auditor)
model: claude-haiku-4-5
argument-hint: [project-path] [--output <file>] [--format <json|markdown>] [--verbose]
---

Use **Agent** tool with `fractary-forge-project-auditor` agent to audit the project with provided arguments.
