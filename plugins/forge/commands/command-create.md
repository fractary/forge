...
/fractary-forge:create-command create-feature --invokes feature-creator

# Create in specific plugin
/fractary-forge:create-command deploy --invokes deployment-manager --plugin faber-cloud

# Create with custom arguments
/fractary-forge:create-command analyze --invokes data-analyzer --arguments "<dataset> [--format <type>]"
```
...
Usage: /fractary-forge:create-command <name> --invokes <agent>
```
...
Usage: /fractary-forge:create-command <name> --invokes <agent>
Example: /fractary-forge:create-command deploy --invokes deployment-manager
```
...
/fractary-forge:create-command analyze --invokes data-analyzer --description "Analyze datasets and generate insights"

# Command with argument hint
/fractary-forge:create-command process --invokes data-processor --arguments "<input-file> --output <path> [--format <type>]"
```
...
Related commands:
- `/fractary-forge:create-agent` - Create an agent
- `/fractary-forge:create-skill` - Create a skill
- `/fractary-forge:create-plugin` - Create a complete plugin
