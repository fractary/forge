...
allowed-tools: Agent(fractary-forge-plugin-creator)
model: claude-haiku-4-5
argument-hint: <name> --type <workflow|primitive|utility> [--requires <plugins>]
---

Use **Agent** tool with `fractary-forge-plugin-creator` agent to create a new plugin with provided arguments.
