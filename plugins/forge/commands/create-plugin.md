---
name: fractary-forge:create-plugin
...
/fractary-forge:create-plugin fractary-faber-data --type workflow --requires fractary-faber

# Create a primitive plugin
/fractary-forge:create-plugin fractary-storage --type primitive

# Create with custom counts
/fractary-forge:create-plugin fractary-faber-mobile --type workflow --agents 2 --skills 5 --commands 3
```
...
Usage: /fractary-forge:create-plugin <name> --type <type>
```

**Missing type flag**:
```
Error: --type flag is required
Usage: /fractary-forge:create-plugin <name> --type <workflow|primitive|utility>
...
/fractary-forge:create-plugin fractary-convert --type utility

# Create with custom placeholder counts
/fractary-forge:create-plugin fractary-faber-mobile --type workflow --agents 2 --skills 5 --commands 3 --requires fractary-faber
```
...
Related commands:
- `/fractary-forge:create-agent` - Create an agent for the plugin
- `/fractary-forge:create-skill` - Create a skill for the plugin
- `/fractary-forge:create-command` - Create a command for the plugin
