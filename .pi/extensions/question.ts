/**
 * Derived from: @mariozechner/pi-coding-agent@0.63.1 examples/extensions/question.ts
 * Changes: None — installed as-is for pi-native agents. CC agents use AskUserQuestion in claude-code-tools.ts.
 * On pi update: diff against updated example and re-apply if needed.
 *
